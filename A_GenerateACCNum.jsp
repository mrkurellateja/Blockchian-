...
<div class="main-body">
    ...
    <div class="content">
        ...
        <div class="content_resize">
          <div class="sb_menu">
            <div class="gadget">
              <table width="738" border="0" cellspacing="2" cellpadding="2">
                <tr>
                  <td width="730"><span class="style10 style14" style="color:#15161a">Generate Account Numbers for <span style="color:#1227b8" class="style30"><%=(String)application.getAttribute("vbank")%></span>'s Users..</span></td>
                </tr>
              </table>
              ...
              <table  cellpadding="0" cellspacing="0"  ">
                <tr style="background-color: #15161a;">
                  <td  width="104"  valign="middle" height="25" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">ID</div></td>
                  <td  width="196" valign="middle" height="25" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">User Name</div></td>
                  <td  width="215" valign="middle" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">Requested Date</div></td>
                  <td  width="145" valign="middle" height="25" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">Account Number </div></td>
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p> -->
         <p class="back-button"><a href="AdminMain.jsp"></a></span><a href="AdminMain.jsp">Back</a></p>
        </div>
      </div>
</div>
