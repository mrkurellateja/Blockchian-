...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="article">
        <h2 style="text-align: center;" class="style10 style14">Agent <span style="color: #1227b8;" class="style30"><%=(String)application.getAttribute("uname")%></span>'s Profile.. </h2>
        <p>&nbsp;</p>
    ...
    box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);" >
        ...
        <div class="clr">
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p> -->
          <p class="back-button"><a href="AgentMain.jsp" class="style11">Back</a></p>
          <!-- <p>&nbsp;</p> -->
        </div>
      </div>
      <div class="clr"></div>
