  ...
  <div class="content">
    <div class="content_resize">
      <div class="article">
        ...
        <p align="center" class="back-button"><a href="UserRegister.jsp" class="style39">Back</a></p>
        <%
        ...
        <p align="center" class="style41" style="color: #1227b8; font-weight: 650;font-size: 22px;">Registration Successfull..</p>
        <p align="center" class="back-button"><a href="UserRegister.jsp" class="style39">Back</a></p> <p>
            <%
									}
