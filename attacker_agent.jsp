          ...
          <div class="article">
            ...
            <table width="453" border="0" align="center" cellpadding="2" cellspacing="2">
              <tr>
                <td ><div align="center">
                    <p class="style49">&nbsp;</p>
                  <p class="style49" style="font-size: 20px;font-weight: 650;">Search User Names :</p>
                </div></td>
                <td ><p>&nbsp; </p>
                    <p>
              ...
              <tr style="background-color: transparent;">
                <td  colspan="2"><div align="center">
                    <input style="width: 300px; height: 40px;border-radius: 12px;" class="login-button" name="submit" type="submit" value="Search" />
                </div></td>
              </tr>
            </table>
            <p align="right" class="back-button" style="width: 300px;"><a href="attacker.jsp" class="style87">Reload Page</a> </p>
          </div>
          <div class="article">
