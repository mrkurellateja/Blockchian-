    ...
    <div class="content_resize">
        <div class="mainbar">
            <div class="article" style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
                <h2><span><i class="fi fi-br-user-headset"></i>Welcome to Agent ::<span class="" style="color: #1227b8;"> <%=(String)application.getAttribute("aname")%></span></span></h2>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <p class="back-button" style="font-size:17px;;margin-left: auto;"><a href="index.html">Logout</a></p>
        </div>
      </div>
      <div class="clr"></div>
    </div>
