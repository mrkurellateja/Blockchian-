...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="article" style="background-color: white;padding: 10px;border:2px solid #1227b8;border-radius: 12px;">
        <h2 class="style10 style14" style="text-align: center;color: #1227b8;">Depositing Amount to Account..</h2>
          ...
          <table width="529" border="0" cellspacing="2" cellpadding="2">
            <tr>
              ...
              <td width="315"><span class="style48 style15">
                <input style="width:350px;height:40px;border-radius:12px;border:2px solid #1227b8;font-size: 18px;" type="text"  name="uname" value="<%=user%>" readonly="readonly"/>
              </span></td>
            </tr>
            <tr>
              ...
              <td><span class="style48 style15">
                <input style="width:350px;height:40px;border-radius:12px;border:2px solid #1227b8;font-size: 18px;" type="text"  name="bank" value="<%=bank%>" readonly="readonly"/>
              </span></td>
            </tr>
            <tr>
              ...
              <td>
                <input style="width:350px;height:40px;border-radius:12px;border:2px solid #1227b8;font-size: 18px;" type="text"  name="amount" class="text" />
             </td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><p class="style48">
                  <input class="login-button" name="submit" type="submit" value="Deposit" />
              </p></td>
            </tr>
          </table>
        </form>
