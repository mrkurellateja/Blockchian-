  ...
  <div class="main-body">
    ...
    <div class="content">
      <div class="content_resize">
        <div class="sb_menu">
          <div class="gadget">
            <div class="table-container" style="border:2px solid #15161a;">
            <table width="544" cellspacing="2" cellpadding="2" >
              <tr>
                <td width="536" style="border: none;"><span class="style10 style14"><strong><marquee behavior="alternate">View  All Deposit Requests and Approve Via Auditor !!! </strong></marquee></span></td>
              </tr>
            </table>
            </div>
            <div class="clr"></div>
          ...
          <td  width="94" valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">Date and Time</div></td>
           <td  width="94" valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">From</div></td>
                <td  width="251"  valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">Status(Send To Bank)</div></td>
                 <td></td>
              </tr>
