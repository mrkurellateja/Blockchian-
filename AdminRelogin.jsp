      ...
      <div class="mainbar">
        <div class="article">
          <form id="form1" name="form1" method="post" action="AdminAuthentication.jsp">
            <div class="article">
              <h2 class="style30"><span class="style29" style="align-items: center;">Invalid Login Details, Please Try Again!!</span></h2>
              <div class="clr"></div>
              <p>&nbsp;</p>
              
              <table class="bank-admin-table"  border="0" cellpadding="2" cellspacing="2">
                <tr>
                  <td>
                    <label for="email" >Select Bank <span>*</span>
                    </label></td>
                  <td>
                      <select name="bank">
                ...
                <tr>
                  <td height="46" ><span class="style35">
                    
                      <label for="label">
                      Vendor Name <span>*</span>
                    </label>
                     </td>
                  <td><input placeholder="Enter the name" id="name" name="userid1" class="text" /></td>
                </tr>
                <tr>
                  <td >
                ...
                <tr>
                  <!-- <td height="47">&nbsp;</td> -->
                  <td><input name="imageField" type="submit"  class="login-button" id="imageField" value="Login" />
                     </td> 
                     <td style="font-weight: 600;">New Vendor <a href="AdminRegister.jsp" class="style30"> Register </a></td>
                </tr>
              </table>
              <div class="clr"></div>
            </div>
          ...
          <p class="back-button"><a href="index.html" class="style13">Back</a></p>
          </div>
      </div>
