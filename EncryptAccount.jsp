        ...
        <div class="sb_menu">
          <div class="gadget">
            <table  border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td width="721"><span class="style100" style="font-size: 22px;font-weight: 650;color: #1227b8;">Encrypting All User Account Numbers..</span></td>
              </tr>
            </table>
            <div class="clr"></div>
            <p>&nbsp;</p>
            ...
            <table width="834" align="center"  cellpadding="0" cellspacing="0"  ">
              <tr style="background-color: #15161a;">
                <td  width="53"  valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style103">ID</div></td>
                <td  width="151" valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style103">User Name</div></td>
                <td  width="157" valign="middle" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style103">Bank</div></td>
                <td  width="176" valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style103">Account Numbers </div></td>
                <td  width="188"  valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style103">Generated Date </div></td>
              </tr>
            ...
            <table width="512" style="border: none;" cellspacing="2" cellpadding="2">
              <tr>
                <td>
                  
                      <input style="padding: 15px;border-radius: 12px;" class="login-button" type="submit" name="Submit" value="Encrypt All Account Numbers"/>
                 </td>
              </tr>
            </table>
            <!-- <p>&nbsp;</p>
