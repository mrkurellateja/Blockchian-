...
<div class="main">
  ...
  <div class="main-body">
    <div class="searchform">
        <form id="formsearch" name="formsearch" method="post" action="AdminAuthentication.jsp">
          <span>
          <input name="editbox_search" class="editbox_search" id="editbox_search" maxlength="80" style="padding-top: 10px;" placeholder="Search our site:" type="text" />
          </span>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="article">
        <h2 class="style10 style14">User <span class="style15" style="color: #1227b8;"><%=(String)application.getAttribute("uname")%></span>'s Mini Statement .. </h2>
        <div class="clr"></div>
        <div class="clr"></div>
        <!-- <p>&nbsp;</p> -->
        <div style="display: flex;flex-direction: row;justify-content: center;align-items: center;">
        <p class="login-button"><a href="U_MiniStatement.jsp">1.Via Auditor</a></p>
        <!-- <p>&nbsp; </p> -->
        <p class="login-button"><a href="U_MiniStatement1.jsp">2.Via Agent </a></p>
        </div>
