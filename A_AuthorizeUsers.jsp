        ...
        <div class="content_resize">
          <div class="sb_menu">
            <div class="gadget">
              ...
              <form id="form1" name="form1" method="post" action="ServerAuthentication.jsp">
                ...
                <table  align="center"  cellpadding="0" cellspacing="0"  ">
                  <tr style="background-color: #15161a;">
                    <td  width="47"  valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">ID</div></td>
                    <td  width="159" valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">User Image</div></td>
                    <td  width="145" valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">User Name</div></td>
                    <td  width="154" valign="middle" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">Mobile</div></td>
                    <td  width="154" valign="middle" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">Bank</div></td>
                    <td  width="154" valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">Address</div></td>
                    <td  width="133" valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">Login Status</div></td>
                    <td  width="112"  valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57">AC_Status </div></td>
                    <td  width="112"  valign="middle" height="34" style="font-size:18px;color:white;font-weight: 500;"><div align="center" class="style5 style56 style57"></div></td>
                  </tr>
              ...
              <h2>&nbsp;</h2>
              <p class="back-button"><a href="AdminMain.jsp">Back</a></p></div>
          </div>
          <div class="clr"></div>
        </div>
      </div>
