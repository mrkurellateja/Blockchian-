...
<link rel='stylesheet' href='https://cdn-uicons.flaticon.com/2.6.0/uicons-regular-rounded/css/uicons-regular-rounded.css'><link rel='stylesheet' href='https://cdn-uicons.flaticon.com/2.6.0/uicons-bold-rounded/css/uicons-bold-rounded.css'>
    ...
    <div class="searchform">
      ...
      <div class="content">
        <div class="content_resize">
          <div class="mainbar">
            <div class="article">
              <h2 align="center"><span class="" style="color:#1227b8;">Welcome To User Login.. </span></h2>
              <form id="form1" name="form1" method="post" action="UserAuthentication.jsp" enctype="multipart/form-data">
                
                <p class="bank-logo" style="margin: 10px;margin-top: 20px;"><i class="fi fi-br-circle-user"></i></p>
                <div class="clr"></div>
                <div class="post_content">
                  <table class="bank-admin-table" cellpadding="2" cellspacing="2">
                    <tr>
                      <td align="center" valign="middle"><label for="email">Select Bank <span>*</span>
                        </label></td>
                      <td>
                          <select name="bank">
                    ...
                    <tr>
                      <td align="center" valign="middle">
                        <label for="label2">Select Finger Print<span> *</span></label></td>
                      <td >
                    ...
                    <tr>
                      ...
                      <td ><input id="name" placeholder="Enter your name" name="userid" class="text" /></td>
                    </tr>
                    <tr>
                        <td align="center" valign="middle">
                            <label>Password <span>*</span></label>
                            </td>
                      <td><input placeholder="Enter your password" type="password" id="pass" name="pass" class="text" /></td>
                    </tr>
                    <tr>
                    
                      <td><input class="login-button" name="imageField" type="submit"  class="LOGIN" id="imageField" value="Login" />
                        <br/>
              ...
              <p class="back-button"><a href="UserLogin.jsp" class="style13">Back</a></p>
              </div>
          </div>
