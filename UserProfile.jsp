  ...
  <div class="main-body">
    ...
    <div class="content">
        <div class="content_resize">
          <div class="article">
            <h2 class="style10 style14" style="text-align: center;">User <span style="color: #1227b8;" class="style15"><%=(String)application.getAttribute("uname")%></span>'s Profile with Finger Print.. </h2>
            <div class="clr"></div>
            <p>&nbsp;</p>
