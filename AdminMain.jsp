...
<body>
    <div class="main">
        <div class="header">
                ...
                <div class="menu_nav">
                    <ul>
                        <li class="active"><a href="AdminMain.jsp">Home Page</a></li>
              ...
              <div class="content">
                  ...
                  <div class="mainbar">
                    <div class="article" style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
                      <h2 style="font-size: 25px;text-align: center;"><span><i class="fi fi-br-bank"></i>  Welcome to Bank ::<span style="color: #1227b8;"><%=(String)application.getAttribute("vbank")%></span></h2>
                  ...
                  <div class="sidebar">
                    ...
                    <div class="gadget">
                      ...
                      <ul class="" style="list-style-type: none;display: flex;margin-left: auto;">
                        <li class="back-button" style="margin-left: auto;margin-right: 10px;"><strong><a href="index.html">Logout</a></strong></li>
                        <li class="back-button" style="margin-right: 20px;"><span class="style13"><a href="UserProfile.jsp">User Profile</a></span></li>
