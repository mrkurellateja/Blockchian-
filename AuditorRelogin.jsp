      ...
      <div class="mainbar">
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="AuditorAuthentication.jsp" enctype="multipart/form-data">
            <table class="bank-admin-table"  border="0" align="left" cellpadding="2" cellspacing="2">
              <tr>
                <td ><label for="email">
              ...
              <tr>
                ...
                <td><input placeholder="Enter User Name" id="name" name="userid" class="text" /></td>
              </tr>
              <tr>
                <td >
              ...
              <tr>
                <!-- <td height="47">&nbsp;</td> -->
                <td><input name="imageField" type="submit"  class="login-button" id="imageField" value="Login" /></td>
                    <td><span class="style38">New User?</span><span class="style11"><a href="AuditorRegister.jsp" class="style30"> Register </a></span></td>
              </tr>
              <!-- <tr>
                <td height="49"></td>
          ...
          <p class="back-button" style="margin-left: auto;"><a href="AuditorLogin.jsp" class="style36">Back</a></p>
        </div>
      </div>
