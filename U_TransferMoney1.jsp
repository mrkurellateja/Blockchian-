        ...
        <form action="U_TransferMoneyStatus1.jsp" method="post" >
          <table class="bank-admin-table" width="529" border="0" cellspacing="2" cellpadding="2">
            <tr>
              ...
              <td>
                <input style="width:350px;height:40px;border-radius:12px;border:2px solid #1227b8;font-size: 18px;" type="text" name="bname" value="<%=bank%>" readonly=""/>
            ...
            <tr>
              ...
              <td >
                <input style="width:350px;height:40px;border-radius:12px;border:2px solid #1227b8;font-size: 18px;" type="text"  name="faccno"  value="<%=facno%>" readonly="" />
            </td>
            </tr>
            <tr>
              <td ><label> To Account <span class="style58">*</span></label>
             </td>
              <td><input placeholder="Enter to account" style="width:350px;height:40px;border-radius:12px;border:2px solid #1227b8;font-size: 18px;" type="text" name="tacno" /></td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <input placeholder="Enter amount" style="width:350px;height:40px;border-radius:12px;border:2px solid #1227b8;font-size: 18px;" type="text"  name="amount" class="text" />
             </td>
            </tr>
            
            <tr>
              <td><label> Angent Name <span>*</span></label>
            </td>
              <td>
                <select name="aname" style="width:350px;height:40px;border-radius:12px;border:2px solid #1227b8;font-size: 18px;">
            ...
            <tr>
              <td>&nbsp;</td>
              <td>
                <input class="login-button" name="submit" type="submit" value="Transfer        " />
           </td>
            </tr>
          </table>
        </form>
        <p class="back-button"><a href="DTW.jsp" >Back</a></p>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
    </div>
