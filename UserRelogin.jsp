          ...
          <form id="form1" name="form1" method="post" action="UserAuthentication.jsp" enctype="multipart/form-data">
            <table class="bank-admin-table"  border="0" align="left" cellpadding="2" cellspacing="2">
              ...
              <tr>
                ...
                <td ><input placeholder="Enter name" id="name" name="userid" class="text" /></td>
              </tr>
              <tr>
                <td >
                    <label for="email">
            ...
            <p class="style12">&nbsp;</p> -->
            <p class="back-button"><a href="UserLogin.jsp" class="style36">Back</a></p>
          </form>
          </div>
      </div>
