...
<div class="main">
    <div class="header">
            ...
            <div class="logo">
                <h1><a href="index.html"><i class="fi fi-br-money-transfer-coin-arrow"></i></a></h1>
            </div>
            <div class="menu_nav">
                <ul>
        ...
        <div class="carousel">
          ...
          <div class="content">
            <div class="content_resize">
                <div class="mainbar">
                    <h2 class="title">Welcome To Admin Registration Page</h2>
                    <form class="register-form" action="AdminRegisterStatus.jsp" method="post" enctype="multipart/form-data">
                        <p><i class="fi fi-br-circle-user"></i></p>
                        ...
                        <select name="bank">
                            <option>Select the Bank</option>
                                            ...
                                            <option>Scet Bank</option>s
                        </select>
    
                        <label>Vendor Name <span>*</span></label>
                        <input placeholder="Enter your name" type="text" name="userid">
                        ...
                        <input placeholder="Enter your MobileNumber" type="text" name="mobile">
    
                        <label>Your Address</label>
                        <textarea placeholder="Enter your address" name="address" rows="2"></textarea>
    
                        <label>Date of Birth <span>*</span></label>
                        <input placeholder="Enter your DOB" type="date" name="dob">
                        ...
                        <label>Select Profile Picture <span>*</span></label>
                        <input style="font-size: 15px;" placeholder="Choose your profile photo" type="file" name="pic">
