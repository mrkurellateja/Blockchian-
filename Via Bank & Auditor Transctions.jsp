  ...
  <div class="main-body">
    ...
    <div class="content">
      <div class="content_resize">
        <div class="article">
          <h2 class="" style="color: #1227b8;">Deposit   money to your account,  transfer money to another account to bank via auditor</h2>
          <div class="clr style60"></div>
          <div><ul class="sb_menu style56">
            <!-- <li><a href="U_TransferMoney.jsp"></a></li> -->
             <li><p><a href="U_DepositMoney.jsp"><i class="fi fi-br-hand-holding-usd"></i>Deposit Amount</a></p></li>
            <li>
              <div class="mainbar">
                <div class="article">
                  <form id="form1" name="form1" method="post" action="">
                    <!-- <p>&nbsp;</p>
                    <div class="clr"></div> -->
                    <!-- <div class="img"><img src="https://t3.ftcdn.net/jpg/01/36/33/14/360_F_136331491_vRh0iHpvyi5juqXvbtujaibNIj6Xvyoh.jpg" width="200" height="210" alt="" class="fl" /></div> -->
                    <div class="post_content">
                      <!-- <li class="style13"> 
                      <p>&nbsp;</p>
                      <p>&nbsp;</p> -->
                      <!-- <p><a href="U_DepositMoney.jsp">Deposit Amount</a></p> -->
                      <!-- </a><a href="U_DepositMoney.jsp"><br /> -->
                       <p><a href="U_TransferMoney.jsp"><i class="fi fi-br-money-coin-transfer"></i>Transfer Amount</p>
...
<!--           
            ...
            <p>&nbsp;</p>
            <p>&nbsp;</p> -->
            <p class="back-button"><a href="UserMain.jsp" class="style55">Back</a></p>
          </div>
