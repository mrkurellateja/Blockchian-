...
<div class="main">
  ...
  <div class="main-body">
    ...
    <div class="content">
     ...
     <li><a href="Au_ViewAllRequests.jsp">View Money deposit Request</a></li>
     
     <li><a href="Au_ViewAllRequests1.jsp">View Transfer Request</a></li>
     
      <li><a href="Au_ViewAllFinancialFrauds.jsp"> View all Analyzing Human Behavior Details (View All Financial Frauds)</a></li>
     
    
    
              </ul>
              <ul class="" style="list-style-type: none; display:flex;flex-direction:row;justify-content:center;margin-left:auto;">
                <li class="back-button" style="margin-right: 20px;"><a href="index.html">Logout</a></li>
                <li class="back-button"  style="margin-right: 30px;"><a href="AuditorMain.jsp">Back</a></li>
