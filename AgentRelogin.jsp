...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style29" style="color: #1227b8;">Invalid Login Details, Please Try Again!!</span></h2>
          <form id="form1" name="form1" method="post" action="AgentAuthentication.jsp" enctype="multipart/form-data">
            <table class="bank-admin-table" cellpadding="2" cellspacing="2">
              ...
              <tr>
                <td >
                  <label for="label2">Select Finger Print <span>*</span></label>
                </td>
                <td>
                  <input type="file" style="padding-top: 10px;" id="label" name="pic2" class="text" />
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td><input id="name" placeholder="Enter the user name" name="userid" class="text" /></td>
              </tr>
              <tr>
                <td>
                ...
                <td><input placeholder="Enter the password" type="password" id="pass" name="pass" class="text" /></td>
              </tr>
              <tr>
                <!-- <td height="47">&nbsp;</td> -->
                <td><input name="imageField" type="submit"  class="LOGIN login-button" id="imageField" value="Login" /></td>
                <td>
                    <span class="style38" style="font-weight: 650;">New User?</span><span class="style10"><a href="AgentRegister.jsp" class="style30"> Register </a></span></td>
              </tr>
            </table>
            <!-- <p>&nbsp;</p>
            <p>&nbsp;</p>
          ...
          <p class="back-button" style="margin-left: auto;"><a href="AgentLogin.jsp" class="style36">Back</a></p>
        </div>
      </div>
