  ...
  <div class="content">
    <div class="content_resize">
      <div class="article" style="text-align: center;">
        <h2 class="style10 style14">Admin <span class="style30" style="color: #1227b8;"><%=(String)application.getAttribute("vname")%></span>'s Profile.. </h2>
        <p>&nbsp;</p>
      
        <table width="519" border="1.5"  cellpadding="0" cellspacing="0" style="background-color: white; border-radius: 8px;
    box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);" >
          ...
          <tr>
            <td valign="middle" height="40"  style="color:white;background-color: #15161a;"><div  class="style15 style7 style4 style3 style22 style33" style="margin-left:20px;"><strong>Bank Name </strong></div></td>
            <td valign="middle" height="40" style="color:#000000;"><div align="left" class="style42 style41 style10" style="margin-left:20px;"><strong>
                <%out.println(s1);%>
            </strong></div></td>
          </tr>
          <tr>
            <td  width="122" valign="middle" height="40"  style="color:white;background-color: #15161a;"><div  class="style15 style7 style4 style3 style22 style33" style="margin-left:20px;"><strong>E-Mail</strong></div></td>
          ...
          <tr>
<td width="122" valign="middle" height="40" style="color:white; background-color: #15161a;">
  <div class="style15 style7 style4 style3 style22 style33" style="margin-left:20px;">
    <strong>Mobile</strong>
          ...
          <tr>
            <td  width="122"  valign="middle" height="40"  style="color:white;background-color: #15161a;"><div  class="style15 style7 style4 style3 style22 style33" style="margin-left:20px;"><strong>Address</strong></div></td>
          ...
          <tr>
            <td  width="122"  valign="middle" height="40"  style="color:white;background-color: #15161a;"><div  class="style15 style7 style4 style3 style22 style33" style="margin-left:20px;"><strong>Date of Birth</strong></div></td>
            <td  width="163" align="left" valign="middle" height="40"><div align="left" class="style42 style41 style10" style="margin-left:20px;"><strong>
                <%out.println(s5);%>
            </strong></div></td>
          </tr>
        ...
        <p align="right">&nbsp;</p>
        <p class="back-button"><a href="" class="style11"></a><a href="AdminMain.jsp" class="style11">Back</a></p>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
    </div>
