        ...
        <div class="content_resize">
          <div class="mainbar">
            <div class="article" style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
              <h2 class="style15" style="color: #1227b8;">Welcome To  money  transfer and deposit Via Agent </h2>
              <!-- <form id="form1" name="form1" method="post" action="">
                <ul class="sb_menu">
                 ...
                 -->
                <p align="center" class="sb_menu-li"><a href="U_DepositMoney1.jsp"><i class="fi fi-rr-deposit-alt"></i>Deposit Amount</a></p>
               
                <p align="center" class="style17">&nbsp;</p>
               
              </form>
              <p class="back-button"><a href="UserMain.jsp" class="style13">Back</a></p>
              <!-- <p>&nbsp;</p>
              <div class="clr"></div>
              <div class="img"></div> -->
            </div>
