...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="article" style="border:2px solid #1227b8;border-radius: 12px;margin-bottom: 40px;">
        <h2 class="style10 style14" style="color: #1227b8;text-align: center;">Depositing Amount to Account..</h2>
       
        <%String user=(String)application.getAttribute("uname");
		  String bank=(String)application.getAttribute("ubank");%>
        <form action="U_DepositMoneyStatus1.jsp" method="post" >
          <table class="bank-admin-table" cellspacing="2" cellpadding="2">
            <tr>
              <td>
            ...
            <tr>
              ...
              <td><input type="text"  name="amount" class="text" />
              </td>
            </tr>
            <tr>
              <td>
                <label for="amount">Select an Agent </label> </td>
              <td>
            ...
            <tr>
              <!-- <td>&nbsp;</td> -->
              <td><p class="style48">
                  <input class="login-button" name="submit" type="submit" value="Update Account" />
              </p></td>
            </tr>
          </table>
        </form>
        <!-- <pc><a href="UserMain.jsp" class="style11"></a></p> -->
        <div class="clr">
          <!-- <p>&nbsp;</p> -->
          <p class="back-button" style="margin-left: auto;"><a href="DTW.jsp" class="style11">Back</a></p>
        </div>
      </div>
      <div class="clr"></div>
    </div>
